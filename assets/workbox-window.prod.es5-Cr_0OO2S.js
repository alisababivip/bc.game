...
function E(t, o) {
  ...
  for (var e = 0, i = new Array(o); e < o; e++) i[e] = t[e];
  return i;
}
function k(t, o) {
  var e;
  if (typeof Symbol > "u" || t[Symbol.iterator] == null) {
    if (
      ...
      (e = (function (f, d) {
        if (f) {
          if (typeof f == "string") return E(f, d);
...
var y = function () {
  var t = this;
  this.promise = new Promise(function (o, e) {
    (t.resolve = o), (t.reject = e);
  });
};
function b(t, o) {
  var e = location.href;
  return new URL(t, e).href === new URL(o, e).href;
}
var g = function (t, o) {
  (this.type = t), Object.assign(this, o);
};
function p(t, o, e) {
  return e
    ? o
      ? o(t)
      : t
    : ((t && t.then) || (t = Promise.resolve(t)), o ? t.then(o) : t);
}
function L() {}
var j = { type: "SKIP_WAITING" };
function P(t, o) {
...
var x = (function (t) {
    ...
    return (
      ...
      (n.cn = function () {
        var s = n.fn,
          a = s.installing;
        n.tn > 0 ||
        !b(a.scriptURL, n.sn.toString()) ||
        performance.now() > n.un + 6e4
          ? ((n.vn = a), s.removeEventListener("updatefound", n.cn))
          : ((n.hn = a), n.an.add(a), n.rn.resolve(a)),
          ++n.tn,
      ...
      (n.ln = function (s) {
        var a = n.fn,
          ...
          l = u.state,
          m = u === n.vn,
          w = { sw: u, isExternal: m, originalEvent: s };
        !m && n.mn && (w.isUpdate = !0),
          ...
          l === "installed"
            ? (n.wn = self.setTimeout(function () {
                l === "installed" &&
                  a.waiting === u &&
                  n.dispatchEvent(new g("waiting", w));
              }, 200))
            : l === "activating" && (clearTimeout(n.wn), m || n.en.resolve(u));
      }),
      (n.dn = function (s) {
        var a = n.hn,
      ...
      (n.gn =
        ((r = function (s) {
          ...
          return p(n.getSW(), function () {
            n.an.has(l) &&
              n.dispatchEvent(
                new g("message", { data: a, originalEvent: s, ports: u, sw: l })
              );
          });
        }),
        function () {
          for (var s = [], a = 0; a < arguments.length; a++)
            s[a] = arguments[a];
          try {
            return Promise.resolve(r.apply(this, s));
          } catch (u) {
    ...
    (h.register = function (v) {
      ...
      try {
        ...
        return (function (s, a) {
          ...
          function () {
            return (
              (r.mn = !!navigator.serviceWorker.controller),
              (r.yn = r.pn()),
              p(r.bn(), function (s) {
                (r.fn = s),
                  r.yn &&
  ...
  (function () {
    ...
    var o = t.prototype;
    return (
      (o.addEventListener = function (e, i) {
        this.Sn(e).add(i);
      }),
      (o.removeEventListener = function (e, i) {
        this.Sn(e).delete(i);
      }),
      (o.dispatchEvent = function (e) {
        e.target = this;
        for (var i, f = k(this.Sn(e.type)); !(i = f()).done; ) (0, i.value)(e);
      }),
      (o.Sn = function (e) {
